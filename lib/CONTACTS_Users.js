...
function Users(){
	...
	///[METHOD][getId_Users]Method to set the Id_Users
	///[PARAMETER][number][nValue]Our new value for Id_Users
	///[RETURNS]Boolean true if done 
	this.getId_Users = function(nValue){
		//Return the member
	...
	///[METHOD][getPseudo]Method to set the Pseudo
	///[PARAMETER][string][sValue]Our new value for Pseudo
	///[RETURNS]Boolean true if done 
	this.getPseudo = function(sValue){
	...
	///[METHOD][getId_Accreditations_Exp_Json]Method to set the Id_Accreditations_Exp_Json
	///[PARAMETER][string][sValue]Our new value for Id_Accreditations_Exp_Json
	///[RETURNS]Boolean true if done 
	this.getId_Accreditations_Exp_Json = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	this.save = function(session, url){
		...
		//set the request header
		oReq.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); 
		oReq.send("Id=0&Session=" + session + "&Action=SAVE&Json=" + oUsers.exportToJson()); 
		//Return the job !
		return true;
	};
	//hack guy !!!
