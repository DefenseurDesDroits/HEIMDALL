//Module : Stocks
//Created by : LUDO
//Generated on : 2017-01-12 11:18:12
...
function Mouvements(){
	...
	this.getId_Stocks = function(){
		//Return the member
		return oMouvements.members.nId_Stocks;
	};
	//hack guy !!!
	...
	this.getId_Contacts = function(){
		//Return the member
		return oMouvements.members.nId_Contacts;
	};
	//hack guy !!!
	...
	this.setId_Stocks = function(nValue){
		...
		if(typeof nValue === 'number'){
			oMouvements.members.nId_Stocks = Math.floor(nValue);
			//Happy end
			return true;
		}
		//Don't fool me next Time !!!
	...
	this.setId_Contacts = function(nValue){
		...
		//security on type guy !!!
		if(typeof nValue === 'number'){
			oMouvements.members.nId_Contacts = Math.floor(nValue);
			//Happy end
			return true;
		}
		//Don't fool me next Time !!!
