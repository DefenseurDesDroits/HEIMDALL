...
function Items(){
	...
	///[METHOD][getId_Items]Method to set the Id_Items
	///[PARAMETER][number][nValue]Our new value for Id_Items
	///[RETURNS]Boolean true if done 
	this.getId_Items = function(nValue){
	...
	///[METHOD][getId_groups_owner]Method to set the Id_groups_owner
	///[PARAMETER][number][nValue]Our new value for Id_groups_owner
	///[RETURNS]Boolean true if done 
	this.getId_groups_owner = function(nValue){
		//security on null guy !!!
		if(nValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getId_Accreditations_Item]Method to set the Id_Accreditations_Item
	///[PARAMETER][number][nValue]Our new value for Id_Accreditations_Item
	///[RETURNS]Boolean true if done 
	this.getId_Accreditations_Item = function(nValue){
		//security on null guy !!!
		if(nValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getModifie]Method to set the Modifie
	///[PARAMETER][string][dtValue]Our new value for Modifie
	///[RETURNS]Boolean true if done 
	this.getModifie = function(dtValue){
		//security on null guy !!!
		if(dtValue == null)
			return false;
		//security on type guy !!!
