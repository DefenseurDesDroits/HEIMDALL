...
function Groups(){
	...
	///[METHOD][getId_Groups]Method to set the Id_Groups
	///[PARAMETER][number][nValue]Our new value for Id_Groups
	///[RETURNS]Boolean true if done 
	this.getId_Groups = function(nValue){
		//Return the member
	...
	///[METHOD][getUGrp_Json]Method to set the UGrp_Json
	///[PARAMETER][string][sValue]Our new value for UGrp_Json
	///[RETURNS]Boolean true if done 
	this.getUGrp_Json = function(sValue){
	...
	///[METHOD][getFichiers]Method to set the Fichiers
	///[PARAMETER][boolean][bValue]Our new value for Fichiers
	///[RETURNS]Boolean true if done 
	this.getFichiers = function(bValue){
		//security on null guy !!!
		if(bValue == null)
			return false;
		//security on type guy !!!
