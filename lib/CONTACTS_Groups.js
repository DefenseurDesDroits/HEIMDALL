//Module : Contacts
//Created by : Ludo
//Generated on : 2016-09-05 02:04:54
//Filename : Groups.js
...
function Groups(){
	...
	this.getNom = function(){
		//Return the member
		return oGroups.members.sNom;
	};
	//hack guy !!!
	this.myGroups.getNom = this.getNom;
	...
	this.setNom = function(sValue){
		...
		if(typeof sValue === 'string'){
			...
			oGroups.members.sNom = sValue.slice(0, 64);
			//Happy end
			return true;
		}
		//Don't fool me next Time !!!
	...
	//hack guy !!!
	this.myGroups.setNom = this.setNom;
