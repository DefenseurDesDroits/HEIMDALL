...
function Organisations(){
	...
	///[METHOD][getId_Organisations]Method to set the Id_Organisations
	///[PARAMETER][number][nValue]Our new value for Id_Organisations
	///[RETURNS]Boolean true if done 
	this.getId_Organisations = function(nValue){
	...
	///[METHOD][getId_Organisation_Type]Method to set the Id_Organisation_Type
	///[PARAMETER][number][nValue]Our new value for Id_Organisation_Type
	///[RETURNS]Boolean true if done 
	this.getId_Organisation_Type = function(nValue){
	...
	this.save = function(session, url){
		...
		//set the request header
		oReq.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); 
		oReq.send("Id=0&Session=" + session + "&Action=SAVE&Json=" + oOrganisations.exportToJson()); 
		//Return the job !
		return true;
	};
	//hack guy !!!
