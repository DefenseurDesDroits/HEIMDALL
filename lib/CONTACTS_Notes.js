...
function Notes(){
	...
	this.getId_Notes = function(){
		...
		return oNotes.myItems.getId_Items();
	};
	//hack guy !!!
	...
	//hack guy !!!
	this.myNotes.setId_Items_Linked = this.setId_Items_Linked;
	...
	this.loadFromArray = function(ary_){
		//Return the job !
		return legacy(oNotes.members, ary_, true);
	};
	//hack guy !!!
	this.myNotes.loadFromArray = this.loadFromArray;
	...
	this.save = function(session, url){
		...
		//set the request header
		oReq.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); 
		oReq.send("Id=0&Session=" + session + "&Action=SAVE&Data=" + oNotes.exportToJson()); 
		//Return the job !
		return true;
	};
	//hack guy !!!
