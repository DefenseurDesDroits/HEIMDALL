...
function Infos(){
	...
	this.getId_Infos = function(){
		...
		return oInfos.myItems.getnId_Items();
	};
	//hack guy !!!
	...
	///[METHOD][getId_Infos]Method to set the Id_Infos
	///[PARAMETER][number][nValue]Our new value for Id_Infos
	///[RETURNS]Boolean true if done 
	this.getId_Infos = function(nValue){
		//Return the member
	...
	///[METHOD][getAdr1]Method to set the Adr1
	///[PARAMETER][string][sValue]Our new value for Adr1
	///[RETURNS]Boolean true if done 
	this.getAdr1 = function(sValue){
	...
	///[METHOD][getAdr2]Method to set the Adr2
	///[PARAMETER][string][sValue]Our new value for Adr2
	///[RETURNS]Boolean true if done 
	this.getAdr2 = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getAdr3]Method to set the Adr3
	///[PARAMETER][string][sValue]Our new value for Adr3
	///[RETURNS]Boolean true if done 
	this.getAdr3 = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getCP]Method to set the CP
	///[PARAMETER][string][sValue]Our new value for CP
	///[RETURNS]Boolean true if done 
	this.getCP = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getCedex]Method to set the Cedex
	///[PARAMETER][string][sValue]Our new value for Cedex
	///[RETURNS]Boolean true if done 
	this.getCedex = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getVille]Method to set the Ville
	///[PARAMETER][string][sValue]Our new value for Ville
	///[RETURNS]Boolean true if done 
	this.getVille = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getTelephone1]Method to set the Telephone1
	///[PARAMETER][string][sValue]Our new value for Telephone1
	///[RETURNS]Boolean true if done 
	this.getTelephone1 = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getCourriel1]Method to set the Courriel1
	///[PARAMETER][string][sValue]Our new value for Courriel1
	///[RETURNS]Boolean true if done 
	this.getCourriel1 = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getTelephone2]Method to set the Telephone2
	///[PARAMETER][string][sValue]Our new value for Telephone2
	///[RETURNS]Boolean true if done 
	this.getTelephone2 = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getCourriel2]Method to set the Courriel2
	///[PARAMETER][string][sValue]Our new value for Courriel2
	///[RETURNS]Boolean true if done 
	this.getCourriel2 = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getSite]Method to set the Site
	///[PARAMETER][string][sValue]Our new value for Site
	///[RETURNS]Boolean true if done 
	this.getSite = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getId_Pays]Method to set the Id_Pays
	///[PARAMETER][number][nValue]Our new value for Id_Pays
	///[RETURNS]Boolean true if done 
	this.getId_Pays = function(nValue){
		//security on null guy !!!
		if(nValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getId_Contact_Infos]Method to set the Id_Contact_Infos
	///[PARAMETER][number][nValue]Our new value for Id_Contact_Infos
	///[RETURNS]Boolean true if done 
	this.getId_Contact_Infos = function(nValue){
		//security on null guy !!!
		if(nValue == null)
			return false;
		//security on type guy !!!
	...
	this.save = function(session, url){
		...
		//set the request header
		oReq.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); 
		oReq.send("Id=0&Session=" + session + "&Action=SAVE&Json=" + oInfos.exportToJson()); 
		//Return the job !
		return true;
	};
	//hack guy !!!
