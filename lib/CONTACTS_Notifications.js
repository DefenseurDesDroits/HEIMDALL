...
function Notifications(){
	...
	///[METHOD][getId_Notifications]Method to set the Id_Notifications
	///[PARAMETER][number][nValue]Our new value for Id_Notifications
	///[RETURNS]Boolean true if done 
	this.getId_Notifications = function(nValue){
	...
	///[METHOD][getMsg]Method to set the Msg
	///[PARAMETER][string][sValue]Our new value for Msg
	///[RETURNS]Boolean true if done 
	this.getMsg = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getId_Auteur]Method to set the Id_Auteur
	///[PARAMETER][number][nValue]Our new value for Id_Auteur
	///[RETURNS]Boolean true if done 
	this.getId_Auteur = function(nValue){
		//security on null guy !!!
		if(nValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getId_Destinataire]Method to set the Id_Destinataire
	///[PARAMETER][number][nValue]Our new value for Id_Destinataire
	///[RETURNS]Boolean true if done 
	this.getId_Destinataire = function(nValue){
		//security on null guy !!!
		if(nValue == null)
			return false;
		//security on type guy !!!
	...
	this.save = function(session, url){
		...
		//set the request header
		oReq.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); 
		oReq.send("Id=0&Session=" + session + "&Action=SAVE&Json=" + oNotifications.exportToJson()); 
		//Return the job !
		return true;
	};
	//hack guy !!!
