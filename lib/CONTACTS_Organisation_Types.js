...
function Organisation_Types(){
	...
	///[METHOD][getId_Organisation_Types]Method to set the Id_Organisation_Types
	///[PARAMETER][number][nValue]Our new value for Id_Organisation_Types
	///[RETURNS]Boolean true if done 
	this.getId_Organisation_Types = function(nValue){
	...
	this.save = function(session, url){
		...
		//set the request header
		oReq.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); 
		oReq.send("Id=0&Session=" + session + "&Action=SAVE&Json=" + oOrganisation_Types.exportToJson()); 
		//Return the job !
		return true;
	};
	//hack guy !!!
