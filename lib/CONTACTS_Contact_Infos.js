...
function Contact_Infos(){
	...
	///[METHOD][getId_Contacts]Method to set the Id_Contacts
	///[PARAMETER][number][nValue]Our new value for Id_Contacts
	///[RETURNS]Boolean true if done 
	this.getId_Contacts = function(nValue){
	...
	///[METHOD][getFonction]Method to set the Fonction
	///[PARAMETER][string][sValue]Our new value for Fonction
	///[RETURNS]Boolean true if done 
	this.getFonction = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getId_Langues]Method to set the Id_Langues
	///[PARAMETER][number][nValue]Our new value for Id_Langues
	///[RETURNS]Boolean true if done 
	this.getId_Langues = function(nValue){
		//security on null guy !!!
		if(nValue == null)
			return false;
		//security on type guy !!!
	...
	this.save = function(session, url){
		...
		//set the request header
		oReq.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); 
		oReq.send("Id=0&Session=" + session + "&Action=SAVE&Json=" + oContact_Infos.exportToJson()); 
		//Return the job !
		return true;
	};
	//hack guy !!!
