...
function Pays(){
	...
	///[METHOD][getCode]Method to set the Code
	///[PARAMETER][string][sValue]Our new value for Code
	///[RETURNS]Boolean true if done 
	this.getCode = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getAlpha2]Method to set the Alpha2
	///[PARAMETER][string][sValue]Our new value for Alpha2
	///[RETURNS]Boolean true if done 
	this.getAlpha2 = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getAlpha3]Method to set the Alpha3
	///[PARAMETER][string][sValue]Our new value for Alpha3
	///[RETURNS]Boolean true if done 
	this.getAlpha3 = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	///[METHOD][getId_Langues_Json]Method to set the Id_Langues_Json
	///[PARAMETER][string][sValue]Our new value for Id_Langues_Json
	///[RETURNS]Boolean true if done 
	this.getId_Langues_Json = function(sValue){
		//security on null guy !!!
		if(sValue == null)
			return false;
		//security on type guy !!!
	...
	this.save = function(session, url){
		...
		//set the request header
		oReq.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); 
		oReq.send("Id=0&Session=" + session + "&Action=SAVE&Json=" + oPays.exportToJson()); 
		//Return the job !
		return true;
	};
	//hack guy !!!
