...
Const HEIMDALL_QM_ORGANISATIONS_Debug = false;
//Const HEIMDALL_QM_ORGANISATIONS_Debug = true;
...
function searchQuery($Args){
    ...
    if(HEIMDALL_QM_ORGANISATIONS_Debug)
        file_put_contents(dirname(__FILE__) . "/../logs/queryManager_Organisations@searchQuery.log", "DEBUG !!!\r\n" );
    ...
    while($nLine < $nCount){
        ...
        //debugging, the desperate way
        if(HEIMDALL_QM_ORGANISATIONS_Debug)
            file_put_contents(dirname(__FILE__) . "/../logs/queryManager_Organisations@searchQuery.log", "JSON : " . $oContact->exportToJson() . "\r\n",  FILE_APPEND );
    ...
    //debugging, the desperate way
    if(HEIMDALL_QM_ORGANISATIONS_Debug)
        file_put_contents(dirname(__FILE__) . "/../logs/queryManager_Organisations@searchQuery.log", "The Query : \r\n " . $sQuery . "\r\n",  FILE_APPEND );
