...
//Filename : Publication_Publications_Links_Stocks_manager.php
//Description : Manage la relation entre Publications et Stocks
...
///[PARAMETER][integer][$nId_Stocks]the id contact infos we want to
...
function InfosgetAllInstanceWith($nId_Contact, $userId = 0){
    ...
    $sQuery .= "\r\n" . "AND xxx.stocks.id_publications = " . Quotes($nId_Contact);
