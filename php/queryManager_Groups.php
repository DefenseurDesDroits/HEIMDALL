...
function searchQuery($Args){
    ...
    if(HEIMDALL_QM_GROUPS_Debug)
        file_put_contents(dirname(__FILE__) . "/../logs/queryManager_Groups@searchQuery.log", "DEBUG !!!\r\n" );
    ...
    //debugging, the desperate way
    if(HEIMDALL_QM_GROUPS_Debug)
        file_put_contents(dirname(__FILE__) . "/../logs/queryManager_Groups@searchQuery.log", "The Query : \r\n " . $sQuery . "\r\n",  FILE_APPEND );
