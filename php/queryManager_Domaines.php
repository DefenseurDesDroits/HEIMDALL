...
//Const HEIMDALL_QM_DOMAINES_Debug = false;
Const HEIMDALL_QM_DOMAINES_Debug = true;
...
function searchQuery($Args){
    ...
    if(HEIMDALL_QM_DOMAINES_Debug)
        file_put_contents(dirname(__FILE__) . "/../logs/queryManager_Domaines@searchQuery.log", "DEBUG !!!\r\n" );
    ...
    //debugging, the desperate way
    if(HEIMDALL_QM_DOMAINES_Debug)
        file_put_contents(dirname(__FILE__) . "/../logs/queryManager_Domaines@searchQuery.log", "The Query : \r\n " . $sQuery . "\r\n",  FILE_APPEND );
